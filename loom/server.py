...
class LoomServer:
    def __init__(self, interface=None, session_manager=None, routes=None):
        ...
        self._routes = routes if routes is not None else routing.get_routes()
    ...
    def start_server(self, demo_db_host, demo_db_port, demo_db_prefix, port, ssl_crt,
        ...
        app = tornado.web.Application(self._routes, **settings)
